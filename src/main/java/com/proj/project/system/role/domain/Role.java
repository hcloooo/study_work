package com.proj.project.system.role.domain;
...
public class Role extends BaseEntity
{
    ...
    /** 数据范围（1：所有数据权限；2：自定义数据权限；3：本院系数据权限；4：本院系及以下数据权限） */
    @Excel(name = "数据范围", readConverterExp = "1=所有数据权限,2=自定义数据权限,3=本院系数据权限,4=本院系及以下数据权限")
